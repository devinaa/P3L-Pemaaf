      ...
      <div class="container-fluid">
              ...
              <div class="card-body">
                <form action="{{ url()->current() }}">
                  <div class="form-group">
                    <label for="inlineFormInput" class="sr-only">ID Transaksi Bayar</label>
                    <input id="tb_id" type="text" placeholder="" name="tb_id" class="mr-3 form-control">
                  </div>
        ...
        <div class="row">
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body">
                  <form action="{{ url('/api/transaksi_bayar') }}" method="post" enctype="multipart/form-data" required>
                     <label>Cabang</label>
                      ...
                      <select name="tj_id" id="tj_id" class="form-control">
                        ...
                        @foreach ($transaksi_juals as $transaksi_jual)
                            <option value="{{ $transaksi_jual->tj_id }}">{{ $transaksi_jual->tj_id }}</option>
                        @endforeach 
                      </select>
                    <div class="form-group">
                      <label>Nama</label>
                      <input type="text" id="jasa_nama" name="jasa_nama" placeholder="" class="form-control" required>
                    </div>
                    <div class="form-group">
                      <label>Harga</label>
                      <input type="number" id="jasa_harga" name="jasa_harga" placeholder="" class="form-control" required>
                    </div>
                    <div class="form-group">
