...
<nav class="side-navbar" role="navigation">
    ...
    <div class="container-fluid">
        <!-- Page Header-->
        <header>
            <h4>Edit Password Pegawai</h4>
        </header>
        <div class="row">
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ url('/editPassword', [Session::get('pgw_id')]) }}" method="post" enctype="multipart/form-data">
                          {{ method_field('PATCH') }}
                          @csrf
                            <div class="form-group">
                                <label>Password Baru</label>
                                <input type="text" id="pgw_password" name="pgw_password" placeholder="" class="form-control" required>
                            </div>
                            <div class="form-group">
