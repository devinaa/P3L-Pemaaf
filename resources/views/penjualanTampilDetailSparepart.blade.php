    ...
    <div class="breadcrumb-holder">
      <div class="container-fluid">
        <ul class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tampil Detail Sparepart Konsumen  </li>
        </ul>
      </div>
    </div>
    <section class="forms">
      <div class="container-fluid">
            <!-- Page Header-->
        <form action="{{ url('/penjualanInputSP', [$transaksi_juals->tj_id]) }}" >
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped table-hover">
                      ...
                      <tr>
                        ...
                        <td>{{ $detail_sparepart->sp_nama }}</td>
