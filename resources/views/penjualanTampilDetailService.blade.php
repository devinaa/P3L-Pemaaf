    ...
    <div class="breadcrumb-holder">
      <div class="container-fluid">
        <ul class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tampil Detail Service Konsumen  </li>
        </ul>
      </div>
    </div>
    <section class="forms">
      <div class="container-fluid">
            <!-- Page Header-->
        <form action="{{ url('/penjualanInputSV', [$transaksi_juals->tj_id]) }}" >
        ...
        <div class="row">
            <div class="col-lg-12">
              <div class="card">
              <br>
                <h4>&emsp;Tampil Detail Service Konsumen</h4>
                <div class="card-body">
                    ...
                    <table class="table table-striped table-hover">
                      ...
                      <tr>
                        <td>{{ $detail_service->tj_id }}</td>
                        <td>{{ $detail_service->jasa_nama }}</td>
                        <td>{{ $detail_service->ds_jasa }}</td>
                        <td>{{ $detail_service->ds_jumlah }}</td>
                        <td>{{ $detail_service->subSV }}</td>
                      </tr>
                    </tbody>
                        @endforeach
                    </table>
