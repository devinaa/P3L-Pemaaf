      ...
      <div class="breadcrumb-holder">
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Input Motor </li>
          </ul>
        </div>
      </div>
      <section class="forms">
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body">
                  <form action="{{ url('/pembayaranInput') }}" method="post" enctype="multipart/form-data">
                     {{ csrf_field() }}
                     <label>ID Transaksi</label>
                      <select name="tj_id" id="tj_id" class="form-control">
                        <option value="">-- Pilih --</option>
                        @foreach ($transaksi_juals as $transaksi_jual)
                            <option value="{{ $transaksi_jual->tj_id }}">{{ $transaksi_jual->tj_id.' '.$transaksi_jual->tj_nama }}</option>
                        @endforeach 
                      </select>
                      <label>Cabang</label>
                      ...
                      <label>Pegawai</label>
                      <select name="pgw_id" id="pgw_id" class="form-control">
                        <option value="">-- Pilih --</option>
                        @foreach ($pegawais as $pegawai)
                            <option value="{{ $pegawai->pgw_id }}">{{ $pegawai->pgw_nama }}</option>
                        @endforeach 
                      </select>
                      <div class="form-group">
                        ...
                        <select class="form-control" name="tb_status" required>
                          ...
                          <option value="Belum Lunas" disabled>Belum Lunas</option>
                        </select>
                      </div>
                      <div class="form-group">
                        <label>Bayar</label>
                        <input type="number" id="tb_bayar" name="tb_bayar" placeholder="" class="form-control" required>
                      </div>
                      <div class="form-group">
                        <label>Diskon</label>
                        <input type="number" id="tb_diskon" name="tb_diskon" placeholder="" class="form-control" required>
                      </div>
                      <div class="form-group">
                        <input type="submit" value="Simpan" class="btn btn-primary">
                        
                          <!-- <a href=" {{ url('/pembayaranInput') }}" class="btn btn-primary">Bayar</a> -->
