        ...
        <div class="breadcrumb-holder">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Input Surat Pengadaan Barang </li>
                </ul>
            </div>
        </div>
        <section class="forms">
          <div class="container-fluid">
            <!-- Page Header-->
            <header>
                <h4>Input Surat Pengadaaan Barang</h4>
            </header>
            <div class="row">
              <div class="col-lg-6">
                <div class="card">
                  <div class="card-body">
                    <form action="{{ url('/suratPengadaanInput') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                      @csrf
                      <!-- referensi dropdown liat di pembayran -->
                       <label>ID Pengadaan</label>
                      <select name="ta_id" id="ta_id" class="form-control">
                        <option value="">-- Pilih --</option>
                        @foreach ($transaksi_pengadaans as $ta)
                        <option value="{{ $ta->ta_id }}">{{ $ta->ta_id}}</option>
                        @endforeach 
                      </select>
                      <label>Status Surat</label>
                        <div class="form-group">
                          <select class="form-control" name="surat_status" required>
                          <option value="">Pilih</option>
                          <option value="Sudah Dicetak" disabled>Sudah Dicetak</option>
