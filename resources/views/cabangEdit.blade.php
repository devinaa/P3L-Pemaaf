    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ url('/api/cabang', [$cabangs->cab_id]) }}" method="post" enctype="multipart/form-data">
                          {{ method_field('PATCH') }}
                          @csrf
                          <div class="form-group">
                            <label>Nama Cabang</label>
                            <input type="text" id="cab_nama" name="cab_nama" placeholder="" class="form-control" value="{{ $cabangs->cab_nama}}" required>
                          </div>
                          <div class="form-group">
                            <label>Alamat</label>
                            <input type="text" id="cab_alamat" name="cab_alamat" placeholder="" class="form-control" value="{{ $cabangs->cab_alamat }}" required>
                          </div>
                          <div class="form-group">
                            <label>No Telepon</label>
                            <input type="text" id="cab_telepon" name="cab_telepon" placeholder="" class="form-control" value="{{ $cabangs->cab_telepon }}" required>
                          </div>
                          <div class="form-group">
                            <label>Website</label>
                            <input type="text" id="cab_web" name="cab_web" placeholder="" class="form-control" value="{{ $cabangs->cab_web }}" required>
                          </div>
                          <div class="form-group">
