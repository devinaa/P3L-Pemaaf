          ...
          <div class="container-fluid">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="card">
                    <div class="card-body">
                      <form action="{{ url('/api/pegawai', [$pegawais->pgw_id]) }}" method="post" enctype="multipart/form-data">
                         {{ method_field('PATCH') }}
                          @csrf
                        <div class="form-group">
                          <label>Nama</label>
                          <input type="text" id="pgw_nama" name="pgw_nama" placeholder="" class="form-control" value="{{ $pegawais->pgw_nama}}" required>
                        </div>
                        <div class="form-group">
                          <label>Alamat</label>
                          <input type="text" id="pgw_alamat" name="pgw_alamat" placeholder="" class="form-control" value="{{ $pegawais->pgw_alamat}}" required>
                        </div>
                        <div class="form-group">
                          <label>No Telp</label>
                          <input type="number" id="pgw_telepon" name="pgw_telepon" placeholder="" class="form-control" value="{{ $pegawais->pgw_telepon}}" required>
                        </div> 
                        <div class="form-group">
                            <label>Gaji</label>
                            <input type="number" id="pgw_gaji" name="pgw_gaji" placeholder="" class="form-control" value="{{ $pegawais->pgw_gaji }}" required>
                        </div>
                        <div class="form-group">
                          <label>Jabatan</label>
                          <select class="form-control" name="pgw_jabatan" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="" id="pgw_username" name="pgw_username" class="form-control" value="{{ $pegawais->pgw_username }}" disable>
                        </div>
                        <div class="form-group">
                            <label>Password</label>
                            <input type="text" placeholder="" id="pgw_password" name="pgw_password" class="form-control" value="{{ $pegawais->pgw_password }}" required>
                        </div>
                        <div class="form-group">
