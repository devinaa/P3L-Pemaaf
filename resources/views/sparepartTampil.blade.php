    ...
    <div class="breadcrumb-holder">
      <div class="container-fluid">
        <ul class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tampil Cabang </li>
        </ul>
      </div>
    </div>
    <section class="forms">
      <div class="container-fluid">
              ...
              <div class="card-body">
                <form action="{{ url()->current() }}">
                  <div class="form-group">
                    <label for="inlineFormInput" class="sr-only">ID Sparepart</label>
                    <input id="sp_nama" type="text" placeholder="" name="sp_nama" class="mr-3 form-control">
                  </div>
        ...
        <form action="{{ url('/sparepartInput') }}" >
              ...
              <br>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped table-hover">
                      ...
                      <tr>
                        <td>{{ $sparepart->sp_id }}</td>
                        <td>{{ $sparepart->sp_nama }}</td>
                        <td>{{ $sparepart->sp_tipe }}</td>
                        <td><img src="{{ URL::to('/') }}/images/{{$sparepart->sp_gambar}}" class="css-class" alt="alt text" style="width:50px"></td>
                        <td>{{ $sparepart->sp_hargaBeli }}</td>
                        <td>{{ $sparepart->sp_hargaJual }}</td>
                        <td>{{ $sparepart->sp_minStok }}</td>
                        <td>{{ $sparepart->sp_stok }}</td>
                        <td>{{ $sparepart->sp_kodeLetak }}</td>
                        <td>{{ $sparepart->sp_merk }}</td>
                        <td>{{ $sparepart->su_id }}</td>
                        <td>
                          <form action="{{ url('/detailSparepartMotor') }}" >
                        ...
                        <td style="width:100px">
                          ...
                          <form action="{{ url('sparepartEdit', [$sparepart->sp_id]) }}" method="post">
                          {{ method_field('GET') }}
                            @csrf
                          ...
                          <form action="{{ url('api/sparepart', [$sparepart->sp_id]) }}" method="post">
                            {{ method_field('DELETE') }}
                            @csrf
