          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="card">
                  <div class="card-body">
                    <form action="{{ url('/penjualanEditMotor', [$detail_motors->dm_id]) }}" method="post" enctype="multipart/form-data" autocomplete="off">
                       {{ method_field('PATCH') }}
                              @csrf
                      <div class="form-group">
                          <label>Plat Motor</label>
                          <input type="text" id="dm_plat" name="dm_plat" value="{{ $detail_motors->dm_plat }}" class="form-control" disabled>
                      </div>
                      <div class="form-group">
                          <label>Status</label>
                          <select class="form-control" name="dm_status" required>
                          <option value="">Pilih</option>
                          <option value="No" disabled>Belum Ready</option>
                          <option value="Ready">Sudah Ready</option>
                          </select>                
                      </div>
                    <div class="form-group">
