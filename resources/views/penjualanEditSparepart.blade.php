        ...
        <div class="breadcrumb-holder">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Transaksi Penjualan Sparepart </li>
                </ul>
            </div>
        </div>
        <section class="forms">
          <div class="container-fluid">
            <!-- Page Header-->
            <header>
                <h4>Edit Transaksi Penjualan Sparepart</h4>
                <!-- YANG BISA DI EDIT HANYA JML SP -->
            </header>
            <div class="row">
              <div class="col-lg-6">
                <div class="card">
                  <div class="card-body">
                    <form action="{{ url('/api/detail_sparepart', [$detail_sparepart->tj_id]) }}" method="post" enctype="multipart/form-data" autocomplete="off">
                      {{ csrf_field() }}
                      <div class="form-group">
                          <label>Kode Sparepart</label>
                          <input type="text" id="sp_id" name="sp_id" value="{{ $detail_sparepart->sp_id }}" placeholder="" class="form-control" disable>
                      </div>
                      <div class="form-group">
                          <label>Nama Sparepart</label>
                          <input type="text" id="sp_nama" name="sp_nama" value="{{ $detail_sparepart->sp_nama }}" placeholder="" class="form-control" disable>
                      </div>
                      <div class="form-group">
                          <label>Merk Sparepart</label>
                          <input type="text" id="sp_merk" name="sp_merk" placeholder="" value="{{ $detail_sparepart->sp_merk }}"class="form-control" disable>
                      </div>
                        <!-- <div class="form-group">
                          <label>Tipe Motor</label>
                          <input type="text" id="mtr_tipe" name="mtr_tipe" value="{{ $transaksi_juals->mtr_tipe }}"placeholder="" class="form-control" disable>
                      </div> -->
                       <div class="form-group">
                          <label>Jumlah</label>
                          <input type="number" id="tj_jumlah" name="tj_jumlah" value="{{ $detail_sparepart->tj_jumlah }}" placeholder="" class="form-control" required>
                      </div>
                      <div class="form-group">
