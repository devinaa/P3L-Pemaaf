...
<header>
    ...
    <body>
        <div class="breadcrumb-holder">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <button type="button" class="btn btn-outline-info" style="margin-left:500px" onclick="printJS('laporanSS', 'html')">
                        Print Form
                    </button>
                </ul>
            </div>
        </div>
        <div class="laporan" id="laporanSS">
            <div class="col-lg-10">
            ...
            <div align="center" hspace=12>
                <p style="margin-top:5px;"><strong>LAPORAN SISA STOK  </strong></p>
            </div>
            <div align="left" hspace=12>
                <p style="margin-top:5px;margin-left:120px"><strong>Tahun: {{Form::label('tj_id', date('Y') )}} </strong></p>
                <p style="margin-top:5px;margin-left:120px"><strong>Tipe Barang: {{Form::label('tj_id', date('F') )}} </strong></p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive" align="center">
                                <table class="table table-striped table-hover" border="3" id="laporanSS"  style="width:70%">
                                    <thead>
                                        <tr>
                                            <th>Bulan</th>
                                            <th style="width:50%">Sisa Stok</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach($laporan as $sisa)
                                        <tr>
                                            <td>{{ $sisa->bulan }}</td>
                                            <td>{{ $sisa->sisa_jumlah }}</td>
                                        </tr>
                                    </tbody>
                                        @endforeach
                                </table>
        ...
        <div class="panel-body" style="align:center; height:40vh; width:80vw">
        ...
        <script>
            var url = "{{url('/chartSisa')}}";
            var bulan = new Array();
            var sisa_jumlah = new Array();
     
        $(document).ready(function(){
          $.get(url, function(response){
            response.forEach(function(data){
                bulan.push(data.bulan);
                sisa_jumlah.push(data.sisa_jumlah);
            });
