              ...
              <div class="card-body">
                <form action="{{ url()->current() }}">
                  <div class="form-group">
                    <label for="inlineFormInput" class="sr-only">Nama Jasa</label>
                    <input id="jasa_nama" type="text" placeholder="" name="jasa_nama" class="mr-3 form-control">
                  </div>
              ...
              <br>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped table-hover">
                      ...
                      <tr>
                        <td>{{ $jasa->jasa_id }}</td>
                        <td>{{ $jasa->jasa_nama }}</td>
                        <td>{{ $jasa->jasa_harga }}</td>
                        <td style="width:100px">
                          <form action="{{ url('/jasaInput') }}" >
                            <input name="tambah" type="hidden" value="Tambah">
                            <button class="btn btn-primary" type="submit">Tambah</button>
                          </form>
                          <form action="{{ url('jasaEdit', [$jasa->jasa_id]) }}" method="post">
                          {{ method_field('GET') }}
                            @csrf
                          ...
                          <form action="{{ url('api/jasa', [$jasa->jasa_id]) }}" method="post">
                            {{ method_field('DELETE') }}
                            @csrf
                            <input name="delete" type="hidden" value="DELETE">
                            <button style="margin-top:-102px; margin-left:132px" class="btn btn-danger" type="submit" onclick=" return confirm('Ingin menghapus data ini?')">Delete</button>
                          </form>
                        </td>
                      </tr>
                      </tbody>
