    ...
    <div class="breadcrumb-holder">
      <div class="container-fluid">
        <ul class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tampil Detail Sparepart Motor </li>
        </ul>
      </div>
    </div>
    <section class="forms">
      <div class="container-fluid">
            <!-- Page Header-->
        <form action="{{ url('/sparepartTampil') }}" >
              ...
              <br>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped table-hover">
                      ...
                      <tbody>
                        @foreach($detail_sparepart_motors as $detailSparepartMotor)
                      <tr>
                        <td>{{ $detailSparepartMotor->sp_id }}</td>
                        <td>{{ $detailSparepartMotor->mtr_id }}</td>
                      </tr>
                    </tbody>
                        @endforeach
                    </table>
