        ...
        <div class="breadcrumb-holder">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Input Transaksi Penjualan Service & Sparepart </li>
                </ul>
            </div>
        </div>
        <section class="forms">
          <div class="container-fluid">
            <!-- Page Header-->
            <header>
                <h4>Input Transaksi Penjualan Service & Sparepart</h4>
            </header>
            <div class="row">
              <div class="col-lg-6">
                <div class="card">
                  <div class="card-body">
                    <form action="{{ url('/api/transaksi_penjualan') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                      @csrf
                      ...
                      <select name="sp_id" id="sp_id" class="form-control">
                        ...
                        <option value="{{ $sparepart->sp_id }}">{{ $sparepart->sp_nama }}</option>
                        @endforeach 
                      </select>
                      ...
                      <select name="ds_jasa" id="ds_jasa" class="form-control">
                        <option value="">-- Pilih --</option>
                        @foreach ($jasas as $jasa)
                        <option value="{{ $jasa->jasa_id }}">{{ $jasa->jasa_nama }}</option>
                        @endforeach 
                      </select>
