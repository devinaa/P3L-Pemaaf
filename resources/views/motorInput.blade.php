        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body">
                  <form action="{{ url('/api/motor') }}" method="post" enctype="multipart/form-data">
                    <!-- <div class="form-group">
                      <label>ID Motor</label>
                      <input type="text" id="mtr_id" name="mtr_id" placeholder="" class="form-control">
                    </div> -->
                    <div class="form-group">
                      <label>Merk</label>
                      <input type="text" id="mtr_merk" name="mtr_merk" placeholder="" class="form-control" required>
                    </div>
                    <div class="form-group">
                      <label>Tipe</label>
                      <input type="text" id="mtr_tipe" name="mtr_tipe" placeholder="" class="form-control" required>
                    </div>
                    <div class="form-group">
