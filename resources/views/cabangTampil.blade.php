              ...
              <div class="card-body">
                <form action="{{ url()->current() }}">
                  <div class="form-group">
                    <label for="inlineFormInput" class="sr-only">Nama Cabang</label>
                    <input id="cab_nama" type="text" placeholder="Nama Cabang" name="cab_nama" class="mr-3 form-control">
                  </div>
                    ...
                    <table class="table table-striped table-hover">
                      ...
                      <tr>
                        ...
                        <td style="width:100px">
                          ...
                          <form action="{{ url('cabangEdit', [$cabang->cab_id]) }}" method="post">
                          {{ method_field('GET') }}
                            @csrf
                          ...
                          <form action="{{ url('api/cabang', [$cabang->cab_id]) }}" method="post">
                            {{ method_field('DELETE') }}
                            @csrf
                            <input name="delete" type="hidden" value="DELETE">
                            <button style="margin-top:-102px; margin-left:132px" class="btn btn-danger" onclick=" return confirm('Ingin menghapus data ini?')" type="submit">Delete</button>
                          </form>
                        </td>
                      </tr>
                    </tbody>
