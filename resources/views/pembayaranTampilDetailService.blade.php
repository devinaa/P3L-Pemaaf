    ...
    <div class="breadcrumb-holder">
      <div class="container-fluid">
        <ul class="breadcrumb">
          ...
          <li class="breadcrumb-item active"> Tampil Detail Service Pelanggan </li>
        </ul>
      </div>
    </div>
    <section class="forms">
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
              <div class="card">
              <br>
                <h4>&emsp;Tampil Detail Service Pelanggan </h4>
                <div class="card-body">
                    ...
                    <table class="table table-striped table-hover">
                      ...
                      <tbody>
                        @foreach($detail_service as $detail_service)
                      <tr>
                        <td>{{ $detail_service->tj_id }}</td>
                        <td>{{ $detail_service->jasa_id }}</td>
