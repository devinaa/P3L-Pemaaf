    ...
    <div class="container-fluid">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h1 class="h4 display"> Cari Jasa</h1>
                    </div>
                    <div class="card-body">
                        <form class="form-inline">
                            <div class="form-group">
                                <label for="inlineFormInput" class="sr-only">ID Jasa</label>
                                <input id="inlineFormInput" type="text" placeholder="" id="jasa_idCari" class="mr-3 form-control">
                            </div>
                            <div class="form-group">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ url('/api/jasa', [$jasas->jasa_id]) }}" method="post" enctype="multipart/form-data">
                          {{ csrf_field() }}
                          {{ method_field('PATCH') }}
                          
                            <div class="form-group">
                                <label>Nama</label>
                                <input type="text" value="{{ $jasas->jasa_nama }}"id="jasa_nama" name="jasa_nama" placeholder="" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Harga</label>
                                <input type="number" value="{{ $jasas->jasa_harga }}"  id="jasa_harga" name="jasa_harga" placeholder="" class="form-control" required>
                            </div>
                            <div class="form-group">
