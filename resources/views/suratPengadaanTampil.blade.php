    ...
    <section class="forms">
      <div class="container-fluid">
        ...
        <form action="{{ url('/suratPengadaanInput') }}" >
          ...
          <button class="btn btn-success" type="submit" style="margin-top:20px;"> <i class="fa fa-plus-square"></i>Surat Pengadaann</button>
        </form>
        <form action="{{ url('/suratPengadaanInputPrint') }}" >
          <input name="tambah" type="hidden" value="Tambah">
                  ...
                  <table class="table table-striped table-hover">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>{{ $transaksi_pengadaan->surat_status }}</td>
                        <td>
                          <form action="{{ url('/suratPengadaanEdit', [$transaksi_pengadaan->ta_id]) }}">
                          {{ method_field('GET') }} 
                            @csrf
