  ...
  <div class="page">
    ...
    <div class="breadcrumb-holder">
      <div class="container-fluid">
        <ul class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Edit Surat Pengadaan </li>
        </ul>
      </div>
    </div>
    ...
    <section class="forms">
          <div class="container-fluid">
              <!-- Page Header-->
              <header>
                  <h4>Edit Surat Pengadaan</h4>
              </header>
              <div class="row">
                <div class="col-lg-6">
                  <div class="card">
                    <div class="card-body">
                      <form action="{{ url('/suratPengadaanEdit', [$transaksi_pengadaans->ta_id]) }}" method="post" enctype="multipart/form-data">
                         {{ method_field('PATCH') }}
                          @csrf
                        <div class="form-group">
                          <label>Transaksi Pengadaan ID </label>
                          <input type="text" id="ta_id" name="ta_id" placeholder="" value="{{ $transaksi_pengadaans->ta_id}}" class="form-control" readonly >
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <option value="Belum Dicetak"disabled>Belum Dicetak</option>
                          </select>
                      </div>
                        <div class="form-group">
