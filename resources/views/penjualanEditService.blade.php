        ...
        <div class="breadcrumb-holder">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Transaksi Penjualan Service </li>
                </ul>
            </div>
        </div>
        <section class="forms">
          <div class="container-fluid">
            <!-- Page Header-->
            <header>
                <h4>Edit Transaksi Penjualan Service</h4>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="card">
                  <div class="card-body">
                    <form action="{{ url('/api/detail_service', [$detail_services->ds_id]) }}" method="post" enctype="multipart/form-data">
                          {{ csrf_field() }}
                          {{ method_field('PATCH') }}
                      <div class="form-group">
                          <label>Jenis Jasa</label>
                          <input type="text" id="ds_jasa" name="ds_jasa" placeholder="" value="{{ $detail_services->ds_jasa }}" class="form-control" disable>
                      </div>
                      <div class="form-group">
                          <label>Merk Sparepart</label>
                          <input type="text" id="sp_merk" name="sp_merk" value="{{ $detail_services->sp_merk }}" placeholder="" class="form-control" disable>
                      </div>
                        <div class="form-group">
                          <label>Tipe Motor</label>
                          <input type="text" id="mtr_tipe" name="mtr_tipe" value="{{ $detail_services->mtr_tipe }}" placeholder="" class="form-control" disable>
                      </div>
                      <div class="form-group">
                          <label>Jumlah</label>
                          <input type="number" id="tj_jumlah" name="tj_jumlah" value="{{ $detail_services->tj_jumlah }}" placeholder="" class="form-control" required>
                      </div>
                      <div class="form-group">
