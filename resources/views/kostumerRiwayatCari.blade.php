          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header d-flex align-items-center">
                <h4>Cari Plat Motor</h4>
              </div>
              <div class="card-body">
                <form action="{{ url('/kostumerRiwayat') }}">
                  <div class="form-group">
                    <label for="inlineFormInput" class="sr-only">Plat Motor</label>
                    <input id="dm_plat" type="text" placeholder="Masukkan Plat Motor Anda" name="dm_plat" class="mr-3 form-control">
                  </div>
                  <div class="form-group">
                    <label for="inlineFormInput" class="sr-only">Plat Motor</label>
                    <input id="tj_telepon" type="text" placeholder="Masukkan Nomor Telepon Anda" name="tj_telepon" class="mr-3 form-control">
                  </div>
