...
<nav class="side-navbar" role="navigation">
      ...
      <div class="breadcrumb-holder">
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Tampil Pegawai </li>
          </ul>
        </div>
      </div>
    <section>
    ...
    @endif
      <div class="container-fluid">
            ...
            <div class="card">
              ...
              <form action="{{ url()->current() }}">
                <div class="form-group">
                  <label for="inlineFormInput" class="sr-only">Nama Pegawai</label>
                  <input id="pgw_nama" type="text" placeholder="" name="pgw_nama" class="mr-3 form-control">
                </div>
        ...
        <form action="{{ url('/pgwTampil/cetak_pdf') }}" >
          <input name="cetak" type="hidden" value="cetak">
          <button class="btn btn-success" type="submit" style="margin-top:-10px; margin-left:18px"> <i class="fa fa-plus-square"></i>Cetak</button>
        </form>
        <div class="col-lg-12">
            <div class="card">
                              ...
                              @foreach($pegawais as $pegawai)
                                <tr>
                                  ...
                                  <td style="width:100px">
                                    ...
                                    <form action="{{ url('pgwEdit', [$pegawai->pgw_id]) }}" method="post">
                                    {{ method_field('GET') }}
                                      @csrf
                                    ...
                                    <form action="{{ url('api/pegawai', [$pegawai->pgw_id]) }}" method="post">
                                      {{ method_field('DELETE') }}
                                      @csrf
                                      <input name="delete" type="hidden" value="DELETE">
                                      <button style="margin-top:-102px; margin-left:132px" class="btn btn-danger" type="submit" onclick="return confirm('beneran dihapus?')">Delete</button>
                                    </form>
                                  </td>
                                </tr>
                            </tbody>
