                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped table-hover">
                      ...
                      <tr>
                        ...
                        <td>{{ $transaksi_jual->tj_tanggal }}</td>
                        ...
                        <td>
                          <form action="{{ url('/pembayaranInput') }}" >
                            <input name="tambah" type="hidden" value="cek">
                            <button class="btn btn-primary" type="submit" onclick=" return confirm('Lakukan pembayaran?')">Bayar</button>
                          </form>
                        </td>
                      </tr>
                      </tbody>
