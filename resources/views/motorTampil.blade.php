              ...
              <div class="card-body">
                <form action="{{ url()->current() }}">
                  <div class="form-group">
                    <label for="inlineFormInput" class="sr-only">Merk Motor</label>
                    <input id="mtr_merk" type="text" placeholder="" name="mtr_merk" class="mr-3 form-control">
                  </div>
              ...
              <br>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped table-hover">
                      ...
                      <tr>
                        <td>{{ $motor->mtr_id }}</td>
                        <td>{{ $motor->mtr_merk }}</td>
                        <td>{{ $motor->mtr_tipe }}</td>
                        <td style="width:100px">
                          <form action="{{ url('/motorInput') }}" >
                            <input name="tambah" type="hidden" value="Tambah">
                            <button class="btn btn-primary" type="submit">Tambah</button>
                          </form>
                          <form action="{{ url('motorEdit', [$motor->mtr_id]) }}" method="post">
                          {{ method_field('GET') }}
                            @csrf
                          ...
                          <form action="{{ url('api/motor', [$motor->mtr_id]) }}" method="post">
                            {{ method_field('DELETE') }}
                            @csrf
