    ...
    <div class="breadcrumb-holder">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <button type="button" class="btn btn-outline-info" style="margin-left:500px" onclick="printJS('laporanJasa', 'html')">
                        Print Form
                    </button>
                </ul>
            </div>
        </div>
        <div class="laporan" id="laporanJasa">
                <div class="col-lg-10">
            ...
            <div align="center" hspace=12>
                <p style="margin-top:5px;"><strong>LAPORAN PENJUALAN JASA  </strong></p>
            </div>
            <div align="left" hspace=12>
                <p style="margin-top:5px;margin-left:160px"><strong>Tahun: {{Form::label('tj_id', date('Y') )}} </strong></p>
                <p style="margin-top:5px;margin-left:160px"><strong>Bulan: {{Form::label('tj_id', date('F') )}} </strong></p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive" align="center">
                                <table class="table table-striped table-hover" border="3" id="laporanJasa" style="width:80%">
                                    <thead>
                                        <tr>
                                            <th>Merk</th>
                                            <th>Tipe Motor</th>
                                    ...
                                    <tbody>
                                        @foreach($laporan as $detail_services)
                                        <tr>
                                            <td>{{ $detail_services->merk }}</td>
                                            <td>{{ $detail_services->tipe }}</td>
                                            <td>{{ $detail_services->nama }}</td>
                                            <td>{{ $detail_services->total }}</td>
                                        </tr>
                                    </tbody>
                                        @endforeach
                                </table>
