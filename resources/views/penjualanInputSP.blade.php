        ...
        <div class="breadcrumb-holder">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Input Transaksi Penjualan Sparepart </li>
                </ul>
            </div>
        </div>
        <section class="forms">
          <div class="container-fluid">
            <!-- Page Header-->
            <header>
                <h4>Input Transaksi Penjualan Sparepart</h4>
            </header>
            <div class="row">
              <div class="col-lg-6">
                <div class="card">
                  <div class="card-body">
                    <form action="{{ url('penjualanInputSP',[$transaksi_juals->tj_id]) }}" method="post" enctype="multipart/form-data" autocomplete="off">
                      @csrf
