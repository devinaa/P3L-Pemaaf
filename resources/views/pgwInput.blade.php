          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="card">
                  <div class="card-body">
                    <form action="{{ url('/api/pegawai') }}" method="post" enctype="multipart/form-data" autocomplete="on">
                      @csrf
                       @if ($errors->any())
                      ...
                      <div class="form-group">
                          <label>Nama</label>
                          <input type="text" id="pgw_nama" name="pgw_nama" placeholder="" class="form-control" required>
                      </div>
                      <div class="form-group">
                          <label>Alamat</label>
                          <input type="text" id="pgw_alamat" name="pgw_alamat" placeholder="" class="form-control" required >
                      </div>
                      <div class="form-group">
                          <label>No Telp</label>
                          <input type="text" id="pgw_telepon" name="pgw_telepon" placeholder="" class="form-control" required>
                      </div>
                      <div class="form-group">
                          <label>Gaji</label>
                          <input type="number" id="pgw_gaji" name="pgw_gaji" placeholder="" class="form-control" required>
                      </div>
                      <div class="form-group">
                          <label>Jabatan</label>
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" placeholder="" id="pgw_username" name="pgw_username" class="form-control" required>
                      </div>
                      <div class="form-group">
                          <label>Password</label>
                          <input type="number" placeholder="" id="pgw_password" name="pgw_password" class="form-control" required>
                      </div>
                     <!-- <div class="form-group">
                          <label>Cabang</label>
                          <input type="number" placeholder="" id="cab_id" name="cab_id" class="form-control" required>
                      </div> -->
                      <label>Cabang</label>
