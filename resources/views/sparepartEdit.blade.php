        ...
        <section class="forms">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ url('/api/sparepart', [$spareparts->sp_id]) }}" method="post" enctype="multipart/form-data">
                              {{ method_field('PATCH') }}
                              @csrf
    
                              <div class="form-group">
                                <label>Nama Sparepart</label>
                                <input type="text" value="{{ $spareparts->sp_nama }}" id="sp_nama"name="sp_nama" placeholder="" class="form-control" required>
                              </div>
                              <div class="form-group">
                                <label>Tipe Sparepart</label>
                                <input type="text" value="{{ $spareparts->sp_tipe }}"id="sp_tipe"name="sp_tipe" placeholder="" class="form-control" required>
                              </div>
                              <div class="form-group">
                                <label>Harga Beli</label>
                                <input type="number" value="{{ $spareparts->sp_hargaBeli }}" id="sp_hargaBeli" name="sp_hargaBeli" placeholder="" class="form-control" required>
                              </div>
                              <div class="form-group">
                                <label>Harga Jual</label>
                                <input type="number" value="{{ $spareparts->sp_hargaJual }}" id="sp_hargaJual" name="sp_hargaJual" placeholder="" class="form-control" required>
                              </div>
                              <div class="form-group">
                                <label>Merk</label>
                                <input type="text" value="{{ $spareparts->sp_merk }}" id="sp_merk" name="sp_merk" placeholder="" class="form-control" required>
                              </div>
                              <div class="form-group">
                                <label>Upload Foto</label>
                                <br>
                              
                                <input type='file' value="{{ $spareparts->sp_gambar}}" id="sp_gambar" name="sp_gambar"  disable/>
                              </div>
                              <div class="form-group">
                                <label>Jumlah Minimal Stok</label>
                                <input type="number" id="sp_minStok" value="{{ $spareparts->sp_minStok }}" name="sp_minStok" placeholder="" class="form-control" required>
                              </div>
                              <div class="form-group">
                                <label>Jumlah Stok</label>
                                <input type="number" value="{{ $spareparts->sp_stok }}" id="sp_stok" name="sp_stok" placeholder="" class="form-control" required>
                              </div>
                              <label>Peletakan Barang</label>
                              <!-- <div class="form-group">
                                <label>Kode Letak</label>
                                <input type="text" value="{{ $spareparts->sp_kodeLetak }}" id="sp_kodeLetak" name="sp_kodeLetak" placeholder="" class="form-control">
                              </div> -->
                              <div class="form-group">
                                <label>Letak</label>
                                <input type="text" value="{{ $kodeLetak[0] }}" id="sp_letak" name="sp_letak" placeholder="" class="form-control" required>
                              </div>
                              <div class="form-group">
                                <label>Ruang</label>
                                <input type="text" placeholder="" value="{{ $kodeLetak[1] }}" id="sp_ruang" name="sp_ruang" class="form-control" required>
                              </div>
                              <div class="form-group">
                                <label>No Urut</label>
                                <input type="number" placeholder="" value="{{ $kodeLetak[2] }}" id="sp_noUrut" name="sp_noUrut" class="form-control" required>
                              </div>
                              <div class="form-group">
                                <label>Supplier ID</label>
                                <input type="text" placeholder="" id="su_id" name="su_id"  class="form-control">
                              </div>
                              <br>
                              <br>
                              <div class="form-group">
