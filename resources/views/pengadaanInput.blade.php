        ...
        <div class="breadcrumb-holder">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Input Pengadaan Barang </li>
                </ul>
            </div>
        </div>
        <section class="forms">
          <div class="container-fluid">
            <!-- Page Header-->
            <header>
                <h4>Input Pengadaaan Barang</h4>
            </header>
            <div class="row">
              <div class="col-lg-6">
                <div class="card">
                  <div class="card-body">
                    <form action="{{ url('/api/transaksi_pengadaan') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                      @csrf
                      ...
                      <select name="su_id" id="su_id" class="form-control">
                       ...
                       <label>Merk Sparepart</label>
                        <select name="sp_id" id="sp_id" class="form-control">
                          ...
                          <option value="{{ $sparepart->sp_id }}">{{ $sparepart->sp_merk }}</option>
                          @endforeach 
                        </select>
                      <div class="form-group">
                          <label>Satuan</label>
                          <input type="number" id="dpgd_satuan" name="dpgd_satuan" placeholder="" class="form-control" required>
                      </div>
                      <div class="form-group">
                          <label>Jumlah</label>
                          <input type="number" id="dpgd_jumlah" name="dpgd_jumlah" placeholder="" class="form-control" required>
                      </div>
                      <div class="form-group">
                          <label>Tanggal</label>
                          <input type="date" id="ta_tanggal" name="ta_tanggal" placeholder="" class="form-control" required>
                      </div>
                      <label>Status</label>
                        <div class="form-group">
                          <select class="form-control" name="ta_status" required>
                          <option value="">-- Pilih --</option>
                          <option value="Ready" disabled>Konfirms</option>
                          <option value="Belum Ready">Belum Di Konfirm</option>
                          </select>
                      </div>
                      <div class="form-group">
