    ...
    <div class="page">
      ...
      <section class="forms">
        <div class="container-fluid">
          <!-- Page Header-->
          <header>
              <h4>Input Supplier & Sales</h4>
          </header>
          <div class="row">
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body">
                  <form action="{{ url('/api/supplier') }}" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      <label>Nama Perusahaan</label>
                      <input type="text" id="su_nama" name="su_nama" placeholder="" class="form-control" required>
                    </div>
                    <div class="form-group">
                      <label>Alamat</label>
                      <input type="text" id="su_alamat" name="su_alamat" placeholder="" class="form-control" required>
                    </div>
                    <div class="form-group">
                      <label>No Telepon</label>
                      <input type="number" id="su_telepon" name="su_telepon" placeholder="" class="form-control" required>
                    </div>
                    <div class="form-group">
                      <label>Nama Sales</label>
                      <input type="text" id="su_namaSales" name="su_namaSales" placeholder="" class="form-control" required>
                    </div>
                    <div class="form-group">
                      <label>No Telepon</label>
                      <input type="number" id="su_teleponSales" name="su_teleponSales" placeholder="" class="form-control" required>
                    </div>
                    <br>
                    <div class="form-group">
