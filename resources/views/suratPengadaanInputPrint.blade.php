        ...
        <div class="breadcrumb-holder">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Print Surat Pengadaan </li>
                </ul>
            </div>
        </div>
        <section class="forms">
          <div class="container-fluid">
            <!-- Page Header-->
            <header>
                <h4>Pilih Print Surat Pengadaan</h4>
            </header>
            <div class="row">
              <div class="col-lg-6">
                <div class="card">
                  <div class="card-body">
                    <form action="{{ url('/suratPengadaan') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                      @csrf
                     {{ method_field('GET') }}
