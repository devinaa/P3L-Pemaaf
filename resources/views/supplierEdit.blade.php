...
<nav class="side-navbar" role="navigation">
    ...
    <div class="page">
      ...
      <div class="breadcrumb-holder">
        ...
        <div class="container-fluid">
          <header>
              <h4>Edit Supplier & Sales</h4>
          </header>
          <div class="row">
              <div class="col-lg-6">
                  <div class="card">
                      <div class="card-body">
                          <form action="{{ url('/api/supplier', [$suppliers->su_id]) }}" method="post" enctype="multipart/form-data">
                              {{ method_field('PATCH') }}
                              @csrf
                              <div class="form-group">
                                  <label>Nama Perusahaan</label>
                                  <input type="text" id="su_nama" name="su_nama" placeholder="" class="form-control" value="{{ $suppliers->su_nama }}" required>
                              </div>
                              <div class="form-group">
                                  <label>Alamat</label>
                                  <input type="text" id="su_alamat" name="su_alamat" placeholder="" class="form-control" value="{{ $suppliers->su_alamat }}" required>
                              </div>
                              <div class="form-group">
                                  <label>No Telepon</label>
                                  <input type="number" id="su_telepon" name="su_telepon" placeholder="" class="form-control" value="{{ $suppliers->su_telepon }}" required>
                              </div>
                               <div class="form-group">
                                  <label>Nama Sales</label>
                                  <input type="text" id="su_namaSales" name="su_namaSales" placeholder="" class="form-control" value="{{ $suppliers->su_namaSales }}" required>
                              </div>
                              <div class="form-group">
                                  <label>No Telepon</label>
                                  <input type="number" id="su_teleponSales" name="su_teleponSales" placeholder="" class="form-control" value="{{ $suppliers->su_teleponSales }}" required> 
                              </div>
                              <br>
                              <div class="form-group">
