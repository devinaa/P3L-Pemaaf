        ...
        <div class="breadcrumb-holder">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Input Transaksi Penjualan Service </li>
                </ul>
            </div>
        </div>
        <section class="forms">
          <div class="container-fluid">
            <!-- Page Header-->
            <header>
                <h4>Input Transaksi Penjualan Service</h4>
            </header>
            <div class="row">
              <div class="col-lg-6">
                <div class="card">
                  <div class="card-body">
                    <form action="{{ url('/penjualanInputSV',[$transaksi_juals->tj_id]) }}" method="post" enctype="multipart/form-data" autocomplete="off">
                      @csrf
                      <!-- <label>ID Transaksi</label> -->
                      <!-- <div class="form-row">
                          
                          <div class="col">
                              <input type="text"name="tj_jenis" class="form-control" placeholder="" value="SV" disable>
                          </div> -->
                          <!-- <div class="col">
                      ...
                      <div class="form-group">
                          <label>Jumlah</label>
                          <input type="number" id="ds_jumlah" name="ds_jumlah" placeholder="" class="form-control" required>
                      </div>
